...
import landlordmod.cards.*;
import landlordmod.relics.MoneyBuysEverything;

import java.util.ArrayList;

import static landlordmod.LandLordThingyMod.*;

public class Landlord extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("The Landlord"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_LANDLORD;
        @SpireEnum(name = "TheLandLord") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "TheLandLord") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public Landlord() {
        super(NAMES[0], Enums.THE_LANDLORD,
        ...
        initializeClass(characterPath("animation/landy.png"),
                SHOULDER_2,
                SHOULDER_1,
                CORPSE,
                getLoadout(),
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(MoneyBuysEverything.ID);
        return retVal;
    }
